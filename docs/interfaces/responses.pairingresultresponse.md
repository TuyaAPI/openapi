[@tuyapi/openapi](../README.md) / [Exports](../modules.md) / [responses](../modules/responses.md) / PairingResultResponse
...
Defined in: [responses.ts:36](https://github.com/TuyaAPI/openapi/blob/a0d0e58/src/responses.ts#L36)
...
Defined in: [responses.ts:42](https://github.com/TuyaAPI/openapi/blob/a0d0e58/src/responses.ts#L42)
